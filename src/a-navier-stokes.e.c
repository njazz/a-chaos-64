...
————————————————————————————————————————————————————————————————
a - navierstokese © andré sier 20030914
...
void main(void)
{
 ...
 post("A-Chaos Lib :: a-navier-stokes.e  " __DATE__" "__TIME__"                                   ©   a n d r é s i e r   2 0 0 4   all rights reserved",tick, 0);
}


void navierstokese_assist(navierstokese *x, void *b, long m, long a, char *s)
{
    if (m==1) { sprintf(s,"ping, (int), (float), ∑, ∂™"); }   
